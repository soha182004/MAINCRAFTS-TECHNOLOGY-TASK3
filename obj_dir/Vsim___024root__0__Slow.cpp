...
VL_ATTR_COLD void Vsim___024root___ctor_var_reset(Vsim___024root* vlSelf) {
    ...
    vlSelf->tb__DOT__data_in = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 8494556493371256177ull);
    vlSelf->tb__DOT__data_out = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 15704253987963422793ull);
